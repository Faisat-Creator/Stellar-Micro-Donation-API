...
const ERROR_CODES = {
  ...
  DONATION_APPROVAL_EXPIRED:   { code: 'DONATION_APPROVAL_EXPIRED',   numeric: 5031 },
  DONATION_ALREADY_APPROVED_BY_SIGNER: { code: 'DONATION_ALREADY_APPROVED_BY_SIGNER', numeric: 5032 },
  INSUFFICIENT_BALANCE_AFTER_RESERVE: { code: 'INSUFFICIENT_BALANCE_AFTER_RESERVE', numeric: 5033 },
  MISSING_SECRET_KEY:          { code: 'MISSING_SECRET_KEY',          numeric: 5034 },
